...
function LoginPageInner() {
  ...
  const { isAuthenticated, isLoading, setTokens } = useAuth()
  ...
  // Already signed in? Bounce to next path.
  useEffect(() => {
  ...
  const handleSubmit = useCallback(
    ...
    [mode, email, password, firstName, lastName, setTokens, router, nextPath]
  )
      ...
      <div className={styles.container}>
        ...
        <header className={styles.hero}>
          ...
          <p className={styles.subtitle}>
            {isMembershipFlow
              ? "Sign in or create an account to continue to membership checkout."
              : mode === "signin"
                ? "Sign in to save progress, bookmarks, Ask history, and downloads."
                : "Create an account to save progress, bookmarks, Ask history, and downloads."}
          </p>
        </header>
        ...
        <main className={styles.content}>
          ...
          <p className={styles.switchMode}>
            ...
            <Link href={`/signup?next=${encodeURIComponent(nextPath)}`} className={styles.switchLink}>
              Create account
            </Link>
          </p>
...
/* Google "G" mark — follows Google brand guidelines (multicolor). */
function GoogleMark() {
  return (
